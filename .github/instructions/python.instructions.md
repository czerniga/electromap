...
- Follow MVC architecture principles by separating concerns (models, views, controllers)
- Separate logic between different files so we have different services for different endpoints